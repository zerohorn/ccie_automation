...
4. After a study session, note any format tweaks here rather than silently drifting per-file

## Status

| File | Blueprint item | Status |
|---|---|---|
| `2-8-terraform.html` | 2.8 Terraform | Done, in use — reference format |
